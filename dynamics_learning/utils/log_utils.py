...
def log_basic(
    ...
    with buddy.log_scope("0_predict"):
        ...
        if plot_means:
            ...
            #_log_timeseries(buddy, viz, y_mu_s, y_mu_p, filter_length, 2, "means")
            #_log_timeseries(buddy, viz, y_mu_s, y_mu_p, filter_length, 3, "means")
            #_log_timeseries(buddy, viz, y_mu_s, y_mu_p, filter_length, 4, "means")
    ...
    with buddy.log_scope("1_filter-t-trajectory"):
        ...
        if plot_means:
            ...
            #_log_filter(buddy, viz, y_mu_f, filter_length, 2, "means-no-noise")
            #_log_filter(buddy, viz, y_mu_f, filter_length, 3, "means-no-noise")
            #_log_filter(buddy, viz, y_mu_f, filter_length, 4, "means-no-noise")
            ...
            _log_filter(
                buddy, viz_noise, y_mu_f, filter_length, 2, "means-meas-noise",
            )
            _log_filter(
                buddy, viz_noise, y_mu_f, filter_length, 3, "means-meas-noise",
            )'''            
